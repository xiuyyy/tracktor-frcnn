...
from .mot_sequence import MOT17Sequence, MOT19Sequence, MOT17LOWFPSSequence, showvideoSequence

###------------------------------------------------------------------------------------------------------------------###
class showvideoWrapper(Dataset):
	"""A wrapper for the show video"""
	def __init__(self, dataloader):
		self._data = []
		self._data.append(showvideoSequence(seq_name='showvideo', dets='', **dataloader))
